...
function Inner_AR() {
    ...
    console.log(arr);
    localStorage.setItem("BOOTSTRAP", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/41137qW7yGL._SX260_.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>BOOTSTRAP GUIDE</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNT0Sd385qIVr8TF83zg3JPKwe4cTwWMmbkf276s5q4GZrESxouuusz_IKbKpIylAnlg4&usqp=CAU"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>BOOTSTRAP EXPLAIN</h5>
