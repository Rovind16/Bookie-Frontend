...
function Inner_typescript() {
    ...
    console.log(arr);
    localStorage.setItem("TYPE SCRIPT", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://goalkicker.com/TypeScriptBook/TypeScriptGrow.png"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>TYPE SCRIPT NOTES</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/41tIzCnmB+L._SL500_.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>TYPE SCRIPT DESIGN</h5>
...
export default Inner_typescript;