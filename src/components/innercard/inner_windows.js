...
function Inner_Windows() {
    ...
    console.log(arr);
    localStorage.setItem("WINDOWS", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6tdEEgXQ7q24dNdqsZjetFTKyUKrfDkI4zA&usqp=CAU"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQS5hX-9D8Ugtz7sDwimLwSGeG63ek7qN4yTA&usqp=CAU"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>WINDOWS ADMINISTRATOR</h5>
