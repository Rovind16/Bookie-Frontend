...
function Inner_power_bi() {
    ...
    console.log(arr);
    localStorage.setItem("POWER BI", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse2.mm.bing.net/th?id=OIP.Ql80-T0fjgWQon-aAkUHrgHaJ4&pid=Api&P=0"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse1.mm.bing.net/th?id=OIP.M2EB-syZYL8FROs6ofzgwQHaIr&pid=Api&P=0"
            alt="new"/>
        </div>
