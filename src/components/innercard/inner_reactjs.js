...
function Inner_power_bi() {
    ...
    console.log(arr);
    localStorage.setItem("REACT JS", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://static.packt-cdn.com/products/9781783551620/cover/smaller"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>REACT JS HOOKS</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://media.springernature.com/full/springer-static/cover-hires/book/978-1-4842-1245-5"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>REACT JS BASICS</h5>
