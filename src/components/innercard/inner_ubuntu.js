...
function Inner_ubuntu() {
    ...
    console.log(arr);
    localStorage.setItem("UBUNTU", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/517x0ynPMtL.jpg"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://images.booksense.com/images/243/234/9781803234243.jpg"
            alt="new"/>
        </div>
