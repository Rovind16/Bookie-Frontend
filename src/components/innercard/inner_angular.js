...
function Inner_AI() {
    ...
    console.log(sum);
    console.log(arr);
    localStorage.setItem("ANGULAR JS", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://media.springernature.com/full/springer-static/cover-hires/book/978-1-4842-2307-9"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>ANGULAR ABSOLUTE</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://www.dotnetcurry.com/angularbook/assets/images/mockup/angular-book.jpg"
            alt="new"/>
        </div>
