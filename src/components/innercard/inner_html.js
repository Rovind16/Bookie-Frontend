...
function Inner_html() {
    ...
    console.log(arr);
    localStorage.setItem("HTML/CSS", arr);
  //  console.log('Image Links:', imageLink);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/51uVuUo0NGL.jpg" alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/71j6aLBlXbL.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>CSS COMPLETE GUIDE</h5>
            <h4>By Orely Kafka</h4>
            <br/>
            <br/>
            <br/>
            <pre>-26%   $290   $<s>370</s></pre>
            <a href='/'><h5>Add to Whishlist</h5></a>
            <img src="http://animalultrasoundassociation.org/wp-content/uploads/2019/08/trustpilot.jpg"
            alt="new"/>
             <div class="qty"><p>QTY :</p><input type="number" name="" class="num"/></div>
