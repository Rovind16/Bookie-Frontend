...
function Inner_Sharp() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://csharp-book.softuni.org/assets/CSharp-Programming-Basics-Book-Cover.png"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="http://csharp-station.com/wp-content/uploads/2016/11/Screen-Shot-2016-11-29-at-2.53.18-PM.png"
            alt="new"/>
        </div>
