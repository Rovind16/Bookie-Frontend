...
function Inner_nosql() {
    ...
    console.log(arr);
    localStorage.setItem("NO SQL", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/815Ehvb8g8L.jpg"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/51ZrXeAlm9L._SL500_.jpg"
            alt="new"/>
        </div>
