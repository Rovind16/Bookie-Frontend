...
function Inner_ionic() {
    ...
    console.log(arr);
    localStorage.setItem("IONIC", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://images-na.ssl-images-amazon.com/images/I/41rmnwi-UsL._SX404_BO1,204,203,200_.jpg"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/41sqtQcPc8L.jpg"
            alt="new"/>
        </div>
