...
function Inner_cent() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/51Ucn4T4AtL._SL500_.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>CENT OS EDITION</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://images.booksense.com/images/707/066/9781032066707.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>CENT OS CONCEPTS</h5>
