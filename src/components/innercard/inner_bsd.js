...
function Inner_bsd() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/A1MeYQoAs0L._AC_UF1000,1000_QL80_.jpg"
            alt="new"/>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/81G+Exp7TQL._AC_UF1000,1000_QL80_.jpg"
            alt="new"/>
             <div class="qty"><p>QTY :</p><input type="number" name="" class="num"/></div>
        </div>
