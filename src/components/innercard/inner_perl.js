...
function Inner_perl() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/51ZlN0S89bL.jpg"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/71YiIxWPKpL.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>PERL PROBLEM SOLVING</h5>
