...
function Inner_mysql() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtRIuocSZsAOtUutFxJMdTGOBo1vKKKZkBiQ&usqp=CAU"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://www.datapine.com/blog/wp-content/uploads/2019/01/t-sql-fundamentals.png"
            alt="new"/>
        </div>
