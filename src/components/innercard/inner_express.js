...
function Inner_express() {
    ...
    console.log(sum);
    console.log(arr);
    localStorage.setItem("EXPRESS JS", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/51n7th-V4zL.jpg"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/713elKMGFkL.jpg"
            alt="new"/>
        </div>
