...
function Inner_DS() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse2.mm.bing.net/th?id=OIP.ZaemmRRHXjyLZSRTSK0KZwHaIW&pid=Api&P=0"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>THE DATA SCIENCE</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse3.mm.bing.net/th?id=OIP.7dDDlmqfeL-KwAwUc3Q6pgAAAA&pid=Api&P=0"
            alt="new"/>
        </div>
