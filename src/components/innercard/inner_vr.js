...
function Inner_VR() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse3.mm.bing.net/th?id=OIP.kcimFjtbdR16rvaKfGNT1wAAAA&pid=Api&P=0"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://assets.titleleaf.com/applebks/product/cover/xl_9781098221195_fc.jpg"
            alt="new"/>
        </div>
