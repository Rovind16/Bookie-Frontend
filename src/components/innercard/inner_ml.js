...
function Inner_ML() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse2.mm.bing.net/th?id=OIP.yT3esHweMtB3MGzNuz2FlAHaKA&pid=Api&P=0"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse2.mm.bing.net/th?id=OIP.h6bejG5JzndeGm4L4jbi1QAAAA&pid=Api&P=0"
            alt="new"/>
        </div>
