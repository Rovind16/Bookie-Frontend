...
function Inner_AI() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse2.mm.bing.net/th?id=OIP.z8Qq2BFCl2-8qfMWDUAQuwHaGs&pid=Api&P=0"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>ARTIFIAL INTELLIGENCE DATA</h5>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://tse1.mm.bing.net/th?id=OIP.SGHZZLbH8lPpUk85vI6f6AHaKi&pid=Api&P=0"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>ARTIFIAL INTELLIGENCE</h5>
