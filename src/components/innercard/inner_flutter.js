...
function Inner_DS() {
    ...
    console.log(arr);
    localStorage.setItem("FLUTTER", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://qph.cf2.quoracdn.net/main-qimg-ba9d62b30ef5f115b71bc4f180fb412f"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://stacksecrets.com/wp-content/uploads/2022/03/Flutter-Recipes-pdf.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>FLUTTER RECEPIES</h5>
