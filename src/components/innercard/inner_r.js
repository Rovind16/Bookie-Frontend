...
function Inner_r() {
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/41NOFqCyYCL.jpg"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/71fy-ZoDO7L.jpg"
            alt="new"/>
        </div>
