...
function Inner_DS() {
    ...
    console.log(arr);
    localStorage.setItem("FEDORA", arr);
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://learning.oreilly.com/library/cover/0596526822/360h/"
            alt="new"/>
        </div>
    ...
    <div class="main_inner">
        <div class="image_inner">
            <img src="https://m.media-amazon.com/images/I/51oTJv67gnL._SL500_.jpg"
            alt="new"/>
        </div>
        
        <div class="description_inner">
           
            <h5>FEDORA LINUX OS</h5>
